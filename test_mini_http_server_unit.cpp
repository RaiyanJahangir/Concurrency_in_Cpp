...
private:
    ...
    static void get_q_int_value_and_default() {
        const std::string_view target = "/work?cpu1=200&io=30&cpu2=x";
        expect_eq(get_q_int(target, "cpu1", 99), 200, "cpu1 should parse from query");
    ...
    static void handle_unknown_route_returns_404() {
        ...
        expect_contains(resp, "Try /work?cpu1=200&io=5000&cpu2=200 (microseconds)", "expected help message");
    }
